...
SLAP_SAITAMA_TEMPLATES = (
    "💞 Arrow 💕 ඔයාට කනේ පාරක් ගැහුව වල් වැඩ කරන්න ගිය නිසා 😒😂",
    "මට ගහන්න එපා අයියේ  🥺🥺 \nරිදෙනවනෙ මට  🥺🥺  ",
    [
...
PING_STRING = (
    "[PONG!!](t.me/gangoffriends)",
    "මම මෙහේ🤪",
)

ITEMS = (
    "[🛡Ģ₳ŇĞ🛡 ØF FŔĮĘŃĐŞ📝](t.me/gangoffriends)",
    "[Sri Lanka 🇱🇰❤️](t.me/gangoffriends)",
...
TABLE = ("t.me/gangoffriends", "t.me/gangoffriendschannel",
         "🎨 එකතු වෙන්න අප සමඟත් \n 👉🛡 @GangOfFriends 🙂 \n 👉🛡 @GangofFriendschannel🙂 ")
